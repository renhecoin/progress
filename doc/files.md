...
* progress.conf: contains configuration settings for progressd or progress-qt
* progressd.pid: stores the process id of progressd while running
...
* debug.log: contains debug information and general logging generated by progressd or progress-qt
