...
"""Verify that starting progress with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start progress with -h for help text")
        ...
        self.log.info("Start progress with -version for version information")
