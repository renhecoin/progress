...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s progress-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  progress-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded progress transaction") + "\n" +
              "  progress-tx [options] -create [commands]   " + _("Create hex-encoded progress transaction") + "\n" +
              "\n";
