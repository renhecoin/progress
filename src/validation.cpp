...
#if defined(NDEBUG)
# error "Progress cannot be compiled without assertions."
#endif
...
int64_t nMaxTipAge = DEFAULT_MAX_TIP_AGE * 160000;
...
const std::string strMessageMagic = "Progress Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PROG additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("progress-scriptch");
